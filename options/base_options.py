...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--dataroot",
            type=str,
            default="./datasets/test_pose/testA",
            help="path to images (should have subfolders trainA, trainB, valA, valB, etc)",
        )
        parser.add_argument("--name", type=str, default="fish_pix2pix", help="name of the experiment. It decides where to store samples and models")
